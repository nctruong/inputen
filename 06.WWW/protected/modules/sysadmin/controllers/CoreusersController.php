...
class CoreusersController extends MiisSysadminController
{
	...
	/**
        ...
        */
        public function actionIndex() {
            $this->addToolbar();
            $model = new CoreUsers('search');
            $model->unsetAttributes();  // clear any default values
            if (isset($_GET['CoreUsers']))
                $model->attributes = $_GET['CoreUsers'];
        ...
        */
        public function actionCreate() {
            ...
            if (isset($_POST['CoreUsers'])) {
                $model->attributes = $_POST['CoreUsers'];
                if ($model->save())
	...
	{
		$model=CoreUsers::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='core-users-form')
		{
