...
class MquestionController extends MiisSysadminController
{
	...
	/**
        ...
        */
        public function actionIndex() {
            $this->addToolbar();
            $model = new Mquestion('search');
            $model->unsetAttributes();  // clear any default values
            if (isset($_GET['Mquestion']))
                $model->attributes = $_GET['Mquestion'];
        ...
        */
        ...
        public function actionDelete() {
            ...
            if (count($cids) > 0) {
                foreach ($cids as $cid) {
                    Mquestion::model()->findByPk($cid)->delete();
                }
            }
            $this->redirect(array('index'));
        }
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mquestion-form')
		{
