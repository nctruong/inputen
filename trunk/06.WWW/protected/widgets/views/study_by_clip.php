                    ...
                    <div class="place_ajax_list_video">
                        <ul class="list_pagin_video">
                            ...
                            <?php foreach ($giaotiep as $k) { ?>
                                <li>
                                    <?php $cat = $k->category; ?>
                                    <a title="<?php echo $k->title?>" href='<?php echo Yii::app()->getBaseUrl(true) . "/" . $cat->taxonomy->slug . "/" . $cat->slug . "-" . $cat->id . "/" . $k->slug . "-" . $k->id . ".html" ?>'>
                                        <?php
                                        $img = $k->image;
                                        if ($img == '') {
                                        ...
                                        ?>
                                        <img title="<?php echo $k->title?>" class="image_box_most_video" src='<?php echo $img ?>' />
