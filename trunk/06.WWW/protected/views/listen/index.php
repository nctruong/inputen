                ...
                foreach ($category as $row) {
                    ...
                    <div class="en-box row-fluid">
                        <div class="row-fluid en-box-title">
                            <?php echo "<a class='title_cate' href='" . Yii::app()->getBaseUrl(true) . "/bai-hoc/" . $row->slug . "-" . $row->id . ".html'>" . $row->title . "</a>" ?>
                        </div>
                        <?php
                        $this->widget('sub_news', array('cat_id' => $row->id, 'type' => 'listen', 'slug' => 'bai-hoc'))
                        ?>
